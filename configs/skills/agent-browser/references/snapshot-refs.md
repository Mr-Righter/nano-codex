...
agent-browser click @e1         # Click triggers page change
agent-browser snapshot -i       # MUST re-snapshot! @e1 is now a different element
```

### When to re-snapshot:
- After clicking links or buttons that navigate
- After form submissions
- After dynamic content loading (dropdowns, modals)
...
```bash
# Scope snapshot to specific container
